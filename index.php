...
<div class="wrapGrid">
    ...
    <div class="imgBlock" data-title="Image 1" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/pavilion-500x333.jpg" />
        </a>
    </div>
    <div class="imgBlock" data-title="Image 2" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/tv-500x333.jpg" />
        </a>
    </div>
    ...
    <div class="imgBlock" data-title="Image 4" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/crossroad-500x333.jpg" />
        </a>
    </div>
    <div class="imgBlock" data-title="Image 5" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/hands1-500x333.jpg" />
        </a>
    </div>
    <div class="imgBlock" data-title="Image 6" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/street-lamp-500x333.jpg" />
        </a>
    </div>
    <div class="imgBlock" data-title="Image 7" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/magpie-500x333.jpg" />
        </a>
    </div>
    <div class="imgBlock" data-title="Image 8" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/ap12-500x333.jpg" />
        </a>
    </div>
    <div class="imgBlock" data-title="Image 9" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/slaveino-petkovo-500x333.jpg" />
        </a>
    </div>
    <div class="imgBlock" data-title="Image 10" data-desc="Lorem ipsum dolor sit amet.">
        <a href="#" class="imgLink">
            <img class="imgGridItem" src="http://photocomma.com/wp-content/uploads/tilt1-500x333.jpg" />
        </a>
    </div>
